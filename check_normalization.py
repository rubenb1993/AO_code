...
axarr[0,0].contourf(xn, yn, Znm_mask[...,3], rstride=1, cstride=1, cmap=cm.gray, linewidth = 0)
axarr[1,0].contourf(xn, yn, Znm_mask[...,4], rstride=1, cstride=1, cmap=cm.gray, linewidth = 0)
axarr[0,1].contourf(xn, yn, np.sqrt(3)*np.real(Cnm_mask[...,3]), rstride=1, cstride=1, cmap=cm.gray, linewidth = 0)
axarr[1,1].contourf(xn, yn, np.sqrt(3)*np.imag(Cnm_mask[...,3]), rstride=1, cstride=1, cmap=cm.gray, linewidth = 0)
print(n, m)
plt.show()
