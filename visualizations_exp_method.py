...
##ax[3].set_xlabel(r'$k$', fontsize = 7, labelpad = -1)
##ax[3].set_ylabel(r'$a_k$', fontsize = 7, labelpad = -3.3)
...
##
##    
####    json.dump(piston_mat.tolist(), open(orig_fold + "piston_mat_k_k.txt", 'w'))
